export enum ActionTypes {
  ...
  GET_CUSTOMER_BY_ID = '[Customer] Get coustomer by id',
  GET_CUSTOMER_BY_ID_SUCCESS = '[Customer] Get coustomer by id success',
  GET_CUSTOMER_BY_ID_FAILURE = '[Customer] Get coustomer by id failure',

  UPDATE_CUSTOMER = '[Customer] ustomer contact',
  UPDATE_CUSTOMER_SUCCESS = '[Customer] Update customer success',
  UPDATE_CUSTOMER_FAILURE = '[Customer] Update customer failure',

  CREATE_CUSTOMER = '[Customer] ustomer contact',
  CREATE_CUSTOMER_SUCCESS = '[Customer] Create customer success',
  CREATE_CUSTOMER_FAILURE = '[Customer] Create customer failure',

  REMOVE_CUSTOMER = '[Customer] ustomer contact',
